(function (undefined) {
    ...
    var Components = require("./CraftyServerComponents");
    ...
    */
    ...
    GUID, FPS, frame, components, entities, entityFactories, handlers, onloads, tick, requestID,
        ...
        */
        stop: function (clearState) {
            ...
            if (clearState) {
                ...
                //}
                initState();
                Components.init(Crafty); //, window, window.document);
            }
